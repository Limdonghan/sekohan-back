...
public class QProImageEntity extends EntityPathBase<ProImageEntity> {
    ...
    public final com.sekohan.sekohanback.entity.QProductEntity prodcutId;
    ...
    public QProImageEntity(Class<? extends ProImageEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.prodcutId = inits.isInitialized("prodcutId") ? new com.sekohan.sekohanback.entity.QProductEntity(forProperty("prodcutId"), inits.get("prodcutId")) : null;
    }
